/* eslint-disable */
/**
 * Extract the internationalization messages from all components
 * add add them to the translation json files.
 */
const fs = require('fs')
...
// Wrap async functions into a promise
const glob = pattern =>
...
for (const locale of locales) {
  ...
  const translationFileName = `src/fe/translations/${locale}.json`
  try {
